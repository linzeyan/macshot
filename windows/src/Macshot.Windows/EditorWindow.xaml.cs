...
public sealed partial class EditorWindow : Window
{
    ...
    /// marks under the pointer instead of grabbing them. Ctrl is macOS's Control: it adds
    /// to the selection, and sweeps a marquee over empty space.
    /// </summary>
    /// <remarks>
    ...
    /// Ctrl are ordinary modifiers and arrive on the event.
    /// </remarks>
